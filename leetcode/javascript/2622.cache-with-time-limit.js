...
TimeLimitedCache.prototype.set = function (key, value, duration) {
    ...
    if (this.cache[key] && this.cache[key].expiredAt > now) {
        this.cache[key] = {
            value,
            expiredAt,
        }
...
// console.log(obj2.set(1, 42, 50)) // false
// console.log(obj2.set(1, 50, 100)) // true
// console.log(obj2.get(1)) // 50
// console.log(obj2.get(1)) // 50
// console.log(obj2.get(1)) // -1
